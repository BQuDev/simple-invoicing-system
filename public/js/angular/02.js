...
app.controller('MainCtrl', ['$scope', '$http', function ($scope, $http) {
  ...
  $scope.gridOptions.columnDefs = [
    ...
    { name: 'c1', enableFiltering: false,cellClass:'editable', displayName: 'critically analyse the extent that the chosen brand’s marketing mix is standardised and/or adapted across international markets using the following elements of the marketing mix - Product,Price,Place, Promotion.Evidence of a range of theories 
', width: '10%' },
    { name: 'c2', enableFiltering: false,cellClass:'editable', displayName: 'required to discuss which IPT ‘best’ describes the internationalisation process that the chosen global brand has undertaken - Review of main IP theories,Discussion which ‘best’ applies’. This may include Born Global, Uppsala, stages etc.Analysis of advantages and disadvantages of the best IP theory selected
' , width: '10%' },
    { name: 'c3', enableFiltering: false,cellClass:'editable', displayName: 'Presentation - Well structured, theory applied to the case, good range of references, Harvard Referencing System usage in citing references. 
', width: '10%'},
