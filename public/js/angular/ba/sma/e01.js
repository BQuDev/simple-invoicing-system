...
app.controller('MainCtrl', ['$scope', '$http', function ($scope, $http) {
  ...
  $scope.gridOptions.columnDefs = [
    ...
    { name: 'c1', type: 'number', enableFiltering: false,cellClass:'editable', displayName: 'Criteria 1', cellTooltip: 
        function( row, col ) {
          return 'Introduction (300 words)-Describe the scope of the report.(FIT analysis of Coca-Cola, UK) brief introduction,current market position and strategy.Briefly introduce the beverage/ soft drink industry in UK outlining its history, current market position and strategy.Outline the structure of the report.';
        }, headerTooltip: 
        function( col ) {
          return 'Introduction (300 words)-Describe the scope of the report.(FIT analysis of Coca-Cola, UK) brief introduction,current market position and strategy.Briefly introduce the beverage/ soft drink industry in UK outlining its history, current market position and strategy.Outline the structure of the report.';
        }
    ...
    { name: 'c2', type: 'number', enableFiltering: false,cellClass:'editable', displayName: 'Criteria 2' , cellTooltip: 
        function( row, col ) {
          return 'TASK A -  Market Environmental Analysis (1000 words) - evaluate conditions in the market environment that Coca-Cola occupies,  comprising of the micro environment and the wider macro environment in which Coca-Cola operates.Highlight the market environment’s critical success factors.';
        }, headerTooltip: 
        function( col ) {
		  return 'TASK A -  Market Environmental Analysis (1000 words) - evaluate conditions in the market environment that Coca-Cola occupies,  comprising of the micro environment and the wider macro environment in which Coca-Cola operates.Highlight the market environment’s critical success factors.';
        }
    ...
    { name: 'c3', type: 'number', enableFiltering: false,cellClass:'editable', displayName: 'Criteria 3' , cellTooltip: 
        function( row, col ) {
          return 'TASK B – Resources and Capability Analysis (1000 words) - Using appropriate analytical tools, evaluate the internal environment of Coca-Cola, highlighting its threshold and unique resources, and its core capabilities/ competencies.';
        }, headerTooltip: 
        function( col ) {
		  return 'TASK B – Resources and Capability Analysis (1000 words) - Using appropriate analytical tools, evaluate the internal environment of Coca-Cola, highlighting its threshold and unique resources, and its core capabilities/ competencies.';
        }
    ...
    { name: 'c4', type: 'number', enableFiltering: false,cellClass:'editable', displayName: 'Criteria 4' , cellTooltip: 
        function( row, col ) {
          return 'TASK C – Strategic FIT Analysis (700 words) - Using the analysis completed in Tasks A and B, evaluate the strategic FIT of Coca-Cola, highlighting how Coca-Cola’s strengths and weaknesses fit the opportunities and threats in its market environment.';
        }, headerTooltip: 
        function( col ) {
		  return 'TASK C – Strategic FIT Analysis (700 words) - Using the analysis completed in Tasks A and B, evaluate the strategic FIT of Coca-Cola, highlighting how Coca-Cola’s strengths and weaknesses fit the opportunities and threats in its market environment.';
        }
    ...
    { name: 'c5', type: 'number', enableFiltering: false,cellClass:'editable', displayName: 'Criteria 5' , cellTooltip: 
        function( row, col ) {
          return 'Presentation Skills (Harvard referencing, style of writing and use of language, word limit) - should contain a title page, a table of contents an introduction and a main body.Sections and subsections should follow a logical order.Language should be appropriate.Sources should be properly cited and displayed in a reference list according to the Harvard System';
        }, headerTooltip: 
        function( col ) {
		  return 'Presentation Skills (Harvard referencing, style of writing and use of language, word limit) - should contain a title page, a table of contents an introduction and a main body.Sections and subsections should follow a logical order.Language should be appropriate.Sources should be properly cited and displayed in a reference list according to the Harvard System';
        }
 ...
 $scope.gridOptions.onRegisterApi = function(gridApi){
          ...
          $.ajax({
                  type        : 'POST',
                  url         : 'save_marks_for_SMA_A_01',
                  data        : formData,
                  dataType    : 'json',
                  success     : function(data) {
					  if((data == 1)&&(document.getElementById('auto_refresh').checked)){
						  $http.get('students_for_marks_SMA_A_01')
            .success(function(data) {
    ...
    $scope.excel_export = function(){
					 ...
					 window.open("save_marks_for_SMA_A_01_excel_export", '_blank');
...
today = dd+'-'+mm+'-'+yyyy;
	window.open("save_marks_for_SMA_A_01_word?san="+Object.keys(san).map(function(k) { return san[k] })[0]+"&export_type=word&d="+today, '_blank');
	}
